...
<span style="color: {{syntax_alt}}">struct</span> <span style="color: {{syntax_alt}}">commit</span> <span style="color: {{fg}}">*</span><span style="color: {{syntax}}">lookup_commit_or_die</span><span style="color: {{fg}}">(</span><span style="color: {{syntax_alt}}">const</span> <span style="color: {{constant}}; font-weight: bold">unsigned</span> <span style="color: {{constant}}; font-weight: bold">char</span> <span style="color: {{fg}}">*</span><span style="color: {{variable}}">sha1</span><span style="color: {{fg}}">,</span> <span style="color: {{syntax_alt}}">const</span> <span style="color: {{constant}}; font-weight: bold">char</span> <span style="color: {{fg}}">*</span><span style="color: {{variable}}">ref_name</span><span style="color: {{fg}}">)</span>
<span style="color: {{fg}}">{</span>
    <span style="color: {{syntax_alt}}">struct</span> <span style="color: {{syntax_alt}}">commit</span> <span style="color: {{fg}}">*</span><span style="color: {{variable}}">c</span> <span style="color: {{fg}}">=</span> <span style="color: {{syntax}}">lookup_commit_reference</span><span style="color: {{fg}}">(</span><span style="color: {{variable}}">sha1</span><span style="color: {{fg}}">);</span>
