...
<span style="color: {{fg}}">{</span>
    <span style="color: {{syntax_alt}}">struct</span> <span style="color: {{syntax}}">commit</span> <span style="color: {{fg}}">*</span><span style="color: {{syntax}}">c</span> <span style="color: {{fg}}">=</span> <span style="color: {{syntax}}">lookup_commit_reference</span><span style="color: {{fg}}">(</span><span style="color: {{variable}}">sha1</span><span style="color: {{fg}}">);</span>
